...
<head>
    ...
    <!-- Bootstrap -->
    <link type="text/css" rel="stylesheet" href="plugins/creative-agency/css/bootstrap.min.css" />

    <!-- Owl Carousel -->
    <link type="text/css" rel="stylesheet" href="plugins/creative-agency/css/owl.carousel.css" />
    <link type="text/css" rel="stylesheet" href="plugins/creative-agency/css/owl.theme.default.css" />

    <!-- Magnific Popup -->
    <link type="text/css" rel="stylesheet" href="plugins/creative-agency/css/magnific-popup.css" />

    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="plugins/creative-agency/css/font-awesome.min.css">

    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="plugins/creative-agency/css/style.css" />
...
<body>
    ...
    <header id="home">
        <!-- Background Image -->
        <div class="bg-img" style="background-image: url('./plugins/creative-agency/img/background1.jpg');">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="index.html">
                            <img class="logo" src="plugins/creative-agency/img/logo.png" alt="logo">
                            <img class="logo-alt" src="plugins/creative-agency/img/logo-alt.png" alt="logo">
                        </a>
                    </div>
                    <!-- /Logo -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="about-slider" class="owl-carousel owl-theme">
                        <img class="img-responsive" src="./plugins/creative-agency/img/about1.jpg" alt="">
                        <img class="img-responsive" src="./plugins/creative-agency/img/about2.jpg" alt="">
                        <img class="img-responsive" src="./plugins/creative-agency/img/about1.jpg" alt="">
                        <img class="img-responsive" src="./plugins/creative-agency/img/about2.jpg" alt="">
                    </div>
                </div>
    ...
    <div id="numbers" class="section sm-padding">
        ...
        <!-- Background Image -->
        <div class="bg-img" style="background-image: url('./plugins/creative-agency/img/background2.jpg');">
            <div class="overlay"></div>
        </div>
        <!-- /Background Image -->
    ...
    <div id="testimonial" class="section md-padding">
        ...
        <!-- Background Image -->
        <div class="bg-img" style="background-image: url('./plugins/creative-agency/img/background3.jpg');">
            <div class="overlay"></div>
        </div>
        <!-- /Background Image -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="footer-logo">
                        <a href="index.html"><img src="plugins/creative-agency/img/logo-alt.png" alt="logo"></a>
                    </div>
                    <!-- /footer logo -->
